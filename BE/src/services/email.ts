...
export const transporter = nodemailer.createTransport({
  ...
  secure: true, // Bật SSL
  auth: {
    user: "hanhnthse181585@fpt.edu.vn",
...
export const sendVerificationEmail = async (
  ...
  const mailOptions = {
    from: "HopeHub",
    to: email,
    subject: "Xác thực Email của bạn - HopeHub",
    html: `
    <!DOCTYPE html>
    <html lang="vi">
    <head>
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>Cảm ơn bạn đã đăng ký tài khoản tại HopeHub. Để hoàn tất quá trình đăng ký, vui lòng sử dụng mã xác thực dưới đây:</p>
...
export const sendResetPasswordEmail = async (
  ...
  const mailOptions = {
    from: "HopeHub",
    to: email,
    subject: "Khôi phục mật khẩu - HopeHub",
    html: `
    <!DOCTYPE html>
    <html lang="vi">
    <head> 
